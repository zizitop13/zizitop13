  ...
  return (
    <div className="status-layout">
      ...
      <aside className="status-summary" aria-label="Professional summary">
        <div className="signal-graph" aria-hidden="true"><span /><span /><span /><span /><span /><span /><span /></div>
